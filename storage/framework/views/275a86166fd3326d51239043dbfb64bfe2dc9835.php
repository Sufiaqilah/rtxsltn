...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="ic" class="col-md-4 col-form-label text-md-right"><?php echo e(__('IC Number')); ?></label>

                            <div class="col-md-6">
                                <input id="ic" type="text" class="form-control <?php $__errorArgs = ['ic'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="ic" value="<?php echo e(old('ic')); ?>" required autocomplete="ic" placeholder="01012345" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="phone_number" value="<?php echo e(old('phone_number')); ?>" required autocomplete="phone_number" placeholder="8885555" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rxsltn\resources\views/auth/register.blade.php ENDPATH**/ ?>